        ...
        <div className="min-h-[80vh] flex items-center justify-center px-6 py-12">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <p className="text-gray-500">Join E-Service Barishal to explore all services with ease</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        <label htmlFor="username" className="text-sm font-bold text-gray-700 ml-1">Choose Username</label>
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#03ab9c] text-white py-4 rounded-2xl font-bold text-lg shadow-lg hover:bg-[#028e82] transition-all transform active:scale-[0.98] disabled:opacity-70 flex items-center justify-center gap-2"
                    >
                        {loading ? 'Processing...' : (
                            <>Sign Up <FaUserPlus className="text-sm" /></>
                        )}
                    </button>
                    ...
                    <div className="text-center pt-4">
                        <p className="text-gray-600">
                            ...
                            <Link to="/login" className="text-[#8a173f] font-bold hover:underline">
                                Login Here
                            </Link>
                        </p>
                    </div>
