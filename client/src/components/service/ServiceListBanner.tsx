...
const ServiceListBanner = ({ serviceName, serviceImage, serviceDescription }: ServiceNameProps) => {
    ...
    return (
        <>
            <div className=" bg-gradient-to-b from-[#8a173f]  to-[#03ab9c] h-60  md:h-[15rem] lg:h-[10rem] rounded-b-full flex md:flex-row flex-col justify-center items-center relative ">
